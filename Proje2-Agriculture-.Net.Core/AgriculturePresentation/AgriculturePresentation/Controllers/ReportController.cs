...
namespace AgriculturePresentation.Controllers
{
    public class ReportController : Controller
    {
        ...
        public IActionResult StaticReport()
        {
            ...
            workBook.Cells[3, 1].Value = "Mercimek";
            ...
            return File(bytes, "application/vnd.openxmlformats-officedocument.spereadsheetml.sheet", "BakliyatRaporu.xlsx");
        }
        ...
        public IActionResult ContactReport()
        {
            using (var workBook=new XLWorkbook()) 
            {
                ...
                using (var stream = new MemoryStream()) 
                {
                    ...
                    return File(content, "application/vnd.openxmlformats-officedocument.spereadsheetml.sheet", "MesajRapor.xlsx");
                }
            }       
        }
        ...
        public IActionResult AnnouncementReport()
        {
            using (var workBook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    workBook.SaveAs(stream);
                    var content = stream.ToArray();
                    return File(content, "application/vnd.openxmlformats-officedocument.spereadsheetml.sheet", "DuyuruRapor.xlsx");
                }
            }
        }
    }
